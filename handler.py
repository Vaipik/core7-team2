...
def birthdays_in(*args) -> None:
    ...
    birthdays = AB.show_near_birthdays(
        days) if days else AB.show_near_birthdays()
    print(*birthdays, sep='\n')
...
def show_contacts(*args) -> None:
    ...
    pages = AB.show_contacts(
        records_per_page) if records_per_page else AB.show_contacts()
...
def handler():
    ...
    while True:
        print(
            ">>> Hello! I am your CLI helper. Please enter show help to see what can i do!")
